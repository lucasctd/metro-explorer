...
"use strict";
var File = (function () {
    function File(id, name, parent, icon, options) {
        this.id = id;
        this.name = name;
        this.parent = parent;
        this.icon = icon;
...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(0), __webpack_require__(13), __webpack_require__(5)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__impl_Explorer__ = __webpack_require__(9);

var e = new __WEBPACK_IMPORTED_MODULE_0__impl_Explorer__["a" /* Explorer */]("#explorer");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ExplorerComponent__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_Upload__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__interfaces_Upload__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__impl_File__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Option__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_huject__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_huject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_huject__);
...
var Explorer = (function () {
    function Explorer(id) {
        this.id = id;
        var options = [
            new __WEBPACK_IMPORTED_MODULE_5__Option__["a" /* Option */]("Show", function (e, file) {
                console.log("Show");
                console.log(file);
            }),
            new __WEBPACK_IMPORTED_MODULE_5__Option__["a" /* Option */]("Edit", function (e, file) {
                console.log("Edit");
                console.log(file);
            }),
            new __WEBPACK_IMPORTED_MODULE_5__Option__["a" /* Option */]("Delete", function (e, file) {
                console.log("Delete");
                console.log(file);
            })
        ];
        var data = { files: [new __WEBPACK_IMPORTED_MODULE_4__impl_File__["a" /* default */](1, "Arquivo", undefined, "file-word-o", options)] };
        this.vue = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
            el: this.id,
            data: data,
            components: {
                "ex-plorer": __WEBPACK_IMPORTED_MODULE_1__components_ExplorerComponent__["a" /* default */]
            }
        });
        this.container = new __WEBPACK_IMPORTED_MODULE_6_huject__["Container"]();
        this.registerDI();
    }
    Explorer.prototype.registerDI = function () {
        this.container.register(__WEBPACK_IMPORTED_MODULE_3__interfaces_Upload__["a" /* default */], __WEBPACK_IMPORTED_MODULE_2__impl_Upload__["a" /* default */]);
    };
    Explorer.prototype.build = function () {
    };
    Explorer.prototype.addFile = function (file) {
    };
    Explorer.prototype.move = function (file) {
    };
    Explorer.prototype.rename = function (file) {
    };
    Explorer.prototype.show = function (file) {
    };
    return Explorer;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_FileComponent__ = __webpack_require__(11);
...
var ExplorerComponent = (function (_super) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["Prop"])(),
        __metadata("design:type", Array)
    ], ExplorerComponent.prototype, "files", void 0);
    ExplorerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2_vue_property_decorator__["Component"])({
            ...
            components: {
                "ex-file": __WEBPACK_IMPORTED_MODULE_1__components_FileComponent__["a" /* default */]
            }
        })
    ], ExplorerComponent);
    return ExplorerComponent;
}(__WEBPACK_IMPORTED_MODULE_0_vue___default.a));
/* harmony default export */ __webpack_exports__["a"] = (ExplorerComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__interfaces_File__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ContextMenuComponent__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_property_decorator__ = __webpack_require__(4);
...
var FileComponent = (function (_super) {
    ...
    Object.defineProperty(FileComponent.prototype, "icon", {
        get: function () {
    ...
    FileComponent.prototype.contextMenu = function (e) {
        this.cmTop = e.clientY - 10;
        this.cmLeft = e.clientX - 10;
        this.showContextMenu = true;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3_vue_property_decorator__["Prop"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__interfaces_File__["a" /* default */])
    ], FileComponent.prototype, "file", void 0);
    FileComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3_vue_property_decorator__["Component"])({
            ...
            components: {
                "ex-context-menu": __WEBPACK_IMPORTED_MODULE_2__components_ContextMenuComponent__["a" /* default */]
            }
        })
    ], FileComponent);
    return FileComponent;
}(__WEBPACK_IMPORTED_MODULE_0_vue___default.a));
/* harmony default export */ __webpack_exports__["a"] = (FileComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interfaces_File__ = __webpack_require__(3);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ContextMenuComponent = (function (_super) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1_vue_property_decorator__["Prop"])({ default: false }),
        __metadata("design:type", Boolean)
    ], ContextMenuComponent.prototype, "show", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1_vue_property_decorator__["Prop"])(),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1_vue_property_decorator__["Prop"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__interfaces_File__["a" /* default */])
    ], ContextMenuComponent.prototype, "file", void 0);
...
/* harmony default export */ __webpack_exports__["a"] = (ContextMenuComponent);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interfaces_File__ = __webpack_require__(3);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var File = (function (_super) {
    ...
    return File;
}(__WEBPACK_IMPORTED_MODULE_0__interfaces_File__["a" /* default */]));
/* harmony default export */ __webpack_exports__["a"] = (File);
...
var Option = (function () {
    ...
    Option.prototype.callbackFunc = function (e, file) {
...
var definition_1 = __webpack_require__(1);
...
var containerfactoryinterface_1 = __webpack_require__(6);
...
var containerfactoryinterface_1 = __webpack_require__(6);
var containerfactory_1 = __webpack_require__(24);
...
var definition_1 = __webpack_require__(1);
var definition_2 = __webpack_require__(1);
var factoryautoproxy_1 = __webpack_require__(23);
